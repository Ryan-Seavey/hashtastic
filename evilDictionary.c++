...
namespace evil
{
    inline constexpr std::string_view dictionary[]{
        ...
        "There are no limits here (limits here, limits here); start out by believing here",
        "You can almost paint with anything, all you have to do is practice",
        "Relax, let it flow (let it flow)", "Think like water (Like water, Water)",
        ...
        "Deadlock withdrawal...", "Name it, uhhh... um... name it W, I don't know.", "\\0", "\7",
        "Every day is exactly the same.", "There is no love here and there is no pain", "Nearly a billion years..."
    };
}